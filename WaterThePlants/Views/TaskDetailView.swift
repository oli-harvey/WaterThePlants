...
//
//    @State private var dueType: DueType = .on
...
//    @State private var dueEveryAmount: Int = 1
//
//    
...
//                        DatePicker("On", selection: completionDate)
//                        
//                    }
//                }// end last completed
...
//                self.dueDate = self.completionDate.addingTimeInterval(self.dueTimein(dueTimePart, amount: dueTimePartAmount))
//            }
//            
//            newTask.name = self.name
//            newTask.dueDate = self.dueDate
//            newTask.completionDate = self.completionDate
...
////        TaskDetailView(editMode: true, task: Task(), dummy: .constant(true)).environment(\.managedObjectContext, PersistenceController.preview.container.viewContext)
////    }
////}
